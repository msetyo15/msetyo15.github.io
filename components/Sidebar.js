        ...
        <div className='flex flex-row justify-between items-center w-full px-6 mt-4'>
          ...
          <div className='social-media-profile-button'>
            <Link href="https://github.com/msetyo15" passHref>
              <button><i class="fa-brands fa-github-alt"></i></button>
            </Link>
          </div>
          <div className='social-media-profile-button'>
      ...
      <div className='my-4'>
        <nav className='px-10'>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-house mx-2"></i> Home</button>
            </Link>
          </div>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-user-tie-hair mx-2"></i> About</button>
            </Link>
          </div>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-file-lines mx-2"></i> Resume</button>
            </Link>
          </div>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-book-open-reader mx-2"></i> Portfolio</button>
            </Link>
          </div>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-server mx-2"></i> Services</button>
            </Link>
          </div>
          <div className='navigation-button'>
            <Link href="#" passHref>
              <button><i class="fa-duotone fa-envelope mx-2"></i> Contact</button>
            </Link>
          </div>
        </nav>
      </div>
      ...
      <div className='flex flex-col items-center py-2'>
        <footer className='text-center'>
          ...
          <div className='download-button '>
            <Link href="#" passHref>
              <button>
                <i class="fa-duotone fa-download mx-2"></i> Download CV
              </button>
            </Link>
          </div>
          {/* Download CV End */}
